...
<table cellpadding="10" style="font-size:larger;font-family:sans-serif;" >
<tr><td  style="font-style:italic; font-size:medium">subject:</td><td><input type="text" name="email" id="pr" size="30"/></td></tr>
<tr><td  style="font-style:italic; font-size:medium">feedback:</td><td><textarea name="password" rows="15" column="40"  id="ps"> </textarea></td></tr>
<tr><td colspan="2"><input id="submit" type="submit" value="Submit" onclick="return k()"/>
