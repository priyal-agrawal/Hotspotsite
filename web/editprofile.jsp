...
<table>
    <tr>
        <td>
            <a href="ViewProfile.jsp"><p style="font-size:larger ;font-family:Georgia">View Your Profile</p></a><br>
   <br>
<a href="editprofile.jsp"><p style="font-size:larger ;font-family:Georgia">Edit Your Profile</p></a>
<br>
...
<br><br>
   ...
   <td>
       <form method="post" action="/Hotspotsite/EditProfile">

<div style="color: red; margin-left:30px;">
<h3>Hello user Edit your detaills</h3>
</div>
...
Name
<td>
<input type=text name="uname"size=20 class="rc">*
</tr>
<tr>
<td class="style">
Address
<td>
<input type="text"  name="uadd"class="rc" value="<%=rs.getString("Mail") %>">*
</tr>
<tr>
<td class="style">
Email
<td>
<input type=text name="uemail"size=20 class="rc" value="<%=rs.getString("Email") %>">*
</tr>
<tr>
...
Phn No
<td>
<input type=text  name="uphn" size=20 class="rc" value="<%=rs.getString("PhonNo") %>">*
</tr>
	<tr>
	<td class="style" colspan="2" align="center">
