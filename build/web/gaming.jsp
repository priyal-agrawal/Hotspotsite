...
<body onLoad="slide('image1',arr);">
                 <div id="img"><img id="image1" height="300px" width="800px" border="0"  /></div>
</body>
<h1>Click picture to choose game....</h1>
</tr>
</table>
<table><tr>
    <td>
        <a href="snl.jsp"> <img src="g/s1.jpg" width="400" height="300"/>
        </a>
     
      </td>
      <td>
        <a href="tictactoe.jsp"> <img src="g/t1.png" width="400" height="300"/>
        </a>
...
<tr>
     <td>
        <a href="chinesecheckers.jsp"> <img src="g/c2.jpg" width="400" height="300"/>
        </a>

      </td>
       <td>
        <a href="sudoku.jsp"> <img src="g/d1.png" width="300" height="300"/>
        </a>
