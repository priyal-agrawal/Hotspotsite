...
<td>
    <form method="post" action="/Hotspotsite/CreateProfile">

<div style="color: red;">
<h3>Hello user this your detaills</h3>
</div>
<div style="float: left; margin-top: 100px;margin-left: 150px; font-size:large">
<%
...
String strselect="select * from registration where UserId=?";
try{
...
<tr><td>User Address</td><td><%=rs.getString("Mail") %></td><th>
<tr><td>User Email</td><td><%=rs.getString("Email") %></td></tr>
<tr><td>User Phn</td><td><%=rs.getString("PhonNo") %></td></tr>
</tr>
<%} }
