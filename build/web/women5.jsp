...
availability information.
  <FORM ACTION="DisplayItem">
           <h2 style="font-family:Showcard Gothic;align:center;font-size:20pt;
           color:yellow">Assessories</h2>
           <table border="0" align="center">
               <tr><td><INPUT TYPE="RADIO" NAME="itemNum" VALUE="a1"><img src="pic/a1.jpg" width="286" height="400" alt="cas1"/>

                   <BR></td>
                   <td><INPUT TYPE="RADIO" NAME="itemNum" VALUE="a2"><img src="pic/a2.jpg" width="286" height="400" alt="cas2"/>
                   <BR></td>
                   <td><INPUT TYPE="RADIO" NAME="itemNum" VALUE="a3"><img src="pic/a3.jpg" width="286" height="400" alt="cas3"/>
               <br></td></tr>
               <tr><td><INPUT TYPE="RADIO" NAME="itemNum" VALUE="a4"><img src="pic/a4.jpg" width="286" height="400" alt="cas4"/>
                   <BR></td>
                   <td><INPUT TYPE="RADIO" NAME="itemNum" VALUE="a5"><img src="pic/a5.jpg" width="286" height="400" alt="cas5"/>
                   <BR></td>
                   <td><INPUT TYPE="RADIO" NAME="itemNum" VALUE="a6"><img src="pic/a6.jpg" width="286" height="400" alt="cas6"/>
               <BR></td></tr>
